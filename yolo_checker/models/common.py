...
from yolo_checker.utils import TryExcept
from yolo_checker.utils.dataloaders import exif_transpose, letterbox
...
from yolo_checker.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yolo_checker.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from yolo_checker.export import export_formats
        from yolo_checker.utils.downloads import is_url
